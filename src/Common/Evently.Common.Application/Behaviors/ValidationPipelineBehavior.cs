...
#region ValidationPipelineBehavior Explanation
// This pipeline behavior is responsible for only validating the ICommand object requests.
// becuase I didn't need to validate query series handlers.
#endregion
